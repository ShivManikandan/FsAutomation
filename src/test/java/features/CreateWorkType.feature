...
Scenario Outline: Create Work Type
...
Then click on New
Then Enter Work Type Name as <WorkTypeName>
Then Enter Description as <Description>
Then click clickSearchOperatingHours
Then click clicknewOperatingHours
Then Create new operating hours by Entering a name as <new operating hours>
Then clicknewTimeZone button
Then selectTimeZone
Then saveNewOperatingHours
Then Enter Estimated Duration as <Estimated Duration>
When Click on Save
...
|'fullstack@testleaf.com'|'SelBootcamp$123'|'Salesforce Project1'|'Specimen'|'UK Shift'|'7'|
